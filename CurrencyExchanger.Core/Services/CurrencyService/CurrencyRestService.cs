...
namespace CurrencyExchanger.Core.Services.CurrencyService
{
    public class CurrencyRestService : ICurrencyService
    {
        ...
        public IList<Rate> GetRates()
        {
            ...
            var ratesObject = JsonConvert.DeserializeObject<List<CurrencyRates>>(response.Content).FirstOrDefault();
